...
const AdditionalComponent = ({ title, text, location }) => {
  return (
    <div className="bg-gray-200 py-0">
      <div className="container mx-auto flex justify-center">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="bg-gray-200 w-full lg:w-3/4 mr-0">
            <div className="p-5">
              <div className="ml-10 sm:ml-14 mt-16 mr-3"> 
                <h3 className="font-bold text-4xl ml-5 text-center lg:text-left sm:px-8 lg:px-0">{title}</h3>
                <p className="mt-4 ml-5 text-center lg:text-left sm:text-sm md:text-base lg:text-lg xl:text-xl lg:pr-24 sm:px-8 lg:px-0">{text}</p>
              </div>
              <div className="relative mt-6 mb-6 ml-10 sm:ml-20">
                <div className="bg-white flex items-center" style={{ borderRadius: '15px' }}>
                  ...
                  <button className="bg-[#00cc99] text-white p-2 m-2 pl-8 pr-8 ml-2 sm:ml-4" style={{ borderRadius: '10px' }}>Search</button>
                </div>
          ...
          {/* Green background */}
          <div className="bg-[#00cc99] w-full lg:w-1/2" style={{ borderBottomLeftRadius: '55px' }}>
