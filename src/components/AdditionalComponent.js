          ...
          <div className="bg-gray-200 w-full lg:w-3/4 mr-0">
            <div className="p-5">
              <div className="ml-10 sm:ml-14 mt-16 mr-3"> {/* Apply ml-14 on small screens */}
                <h3 className="font-bold text-4xl ml-9 text-center lg:text-left sm:px-8 lg:px-0">Search, Find, & Apply</h3>
                <p className="mt-4 ml-9 text-center lg:text-left sm:text-sm md:text-base lg:text-lg xl:text-xl lg:pr-24 sm:px-8 lg:px-0">lorem ipsum dolor sit amet, consectetur adipiscing elit, Sed quis lacus non orci euismod vestibulum vitae ut ex, Quisque ut arcu at lectus tristique auctor sit amet at turpis.</p>
              </div>
              <div className="bg-white flex items-center mt-6 mb-6 ml-10 sm:ml-20" style={{ borderRadius: '15px' }}>
